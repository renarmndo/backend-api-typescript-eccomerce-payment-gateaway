...
export class AuthServices {
    static async register(data) {
        try {
            ...
            if (existingEmail) {
                throw new CustomError("Email sudah terdaftar, Gunakan email lain atau silahkan Login", 409);
            }
            // hashing password
    ...
    static async login(data) {
        ...
        try {
            ...
            if (!jwtsecret) {
                ...
                throw new Error("JWT_SECRET tidak ditemukan pada environment variables");
            }
            // genearete token
